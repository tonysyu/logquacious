...
The sources for logquacious can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/tonysyu/logquacious
.. _tarball: https://github.com/tonysyu/logquacious/tarball/master
